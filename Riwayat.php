...
<body>
    ...
    <div class="invoice-container">
        ...
        while($row = $result->fetch_assoc()) {
            // Mengatur status default menjadi "Belum Selesai" jika tiket belum dicetak minimal sekali
            $status_pemesanan = $row["status_pemesanan"] == "Sudah Selesai" ? "Sudah Selesai" : "Belum Selesai";
                echo "<tr>
                        <td>" . $row["nama"] . "</td>
                        <td>" . $row["email"] . "</td>
                        <td>" . $row["telepon"] . "</td>
